...
Model_autofit <- auto.arima(deseasonal_residential_price,max.D=0,max.P = 0,max.Q=0,approximation = TRUE) #right now is just telling the model dont worry about seasonality
...
When you move from 1,1,1 to 2,1,1 its very similar. The coefficients compensate for each other. 
