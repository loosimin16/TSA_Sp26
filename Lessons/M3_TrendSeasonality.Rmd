...
HP5 has interesting positive seasonality, HP15 is good example
...
```
Not a significant regression for HP15.
Significant regression for HP4.
...
autoplot(ts_inflow_data[,iHP]) + autolayer(ts_detrend_inflow)
...
for (i in 1:nobs){
  season_inflow_data[i] <- beta_int + beta_coeff*dummies
}
